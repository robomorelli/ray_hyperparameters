...
def prep_sentinel(df, columns, columns_subset, dataset_subset = 10000, train_val_split=0.2, scale=True):
    ...
    X_train, X_test, y_train, y_test = train_test_split(dfNorm, dfNorm, train_size=train_val_split, shuffle=False)
